...
const moduleName = '@openmrs/esm-search-app';

const options = {
  featureName: 'search-patient',
  moduleName,
};
 ...
 */
export const searchPatientDashboardLink = getSyncLifecycle(createDashboardLink(dashboardMeta), options);

// export const appointmentsCalendarDashboardLink = getSyncLifecycle(
//   createDashboardLink(searchPatientDashboardMeta),
//   options,
// );
